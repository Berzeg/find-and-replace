    ...
    return (
      $.div({tabIndex: -1, className: 'find-and-replace'},
        ...
        $.svg({style: {display: 'none'}, innerHTML: `
          ...
          <symbol id="find-and-replace-icon-rename-directory" viewBox="0 0 20 16" stroke="none" fill-rule="evenodd">
              <rect opacity="0.6" x="5.5" y="3" width="4" height="10"></rect>
              <polygon points="3.5 3 4.5 3 2.5 13 1.5 13"></polygon>
              <rect opacity="0.6" x="14.5" y="3" width="4" height="10"></rect>
              <polygon points="12.5 3 13.5 3 11.5 13 10.5 13"></polygon>
          </symbol>
