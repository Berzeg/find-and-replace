...
class ProjectFindView {
        ...
        $.header({className: 'header'},
          ...
          $.span({className: 'header-item options-label pull-right'},
            ...
            $.span({className: 'btn-group btn-toggle btn-group-options'},
              ...
              $.button({ref: 'renameDirectoryOptionButton', className: 'btn option-rename-directory'},
                $.svg({className: "icon", innerHTML:`<use xlink:href="#find-and-replace-icon-rename-directory" />`})
              )
            )
          )
        ),
  ...
  didShow() {
    ...
    this.tooltipSubscriptions = new CompositeDisposable(
      ...
      atom.tooltips.add(this.refs.renameDirectoryOptionButton, {
        title: "Rename Directory",
        keyBindingCommand: 'project-find:toggle-rename-directory-option',
        keyBindingTarget: this.findEditor.element
      }),
  ...
  handleEvents() {
    ...
    this.subscriptions.add(atom.commands.add(this.element, {
      ...
      'project-find:toggle-rename-directory-option': () => this.toggleRenameDirectoryOption(),
    ...
    this.refs.renameDirectoryOptionButton.addEventListener('click', () => this.toggleRenameDirectoryOption());
  ...
  updateOptionsLabel() {
    ...
    if (this.model.getFindOptions().renameDirectory) {
      label.push('Rename Directory');
    }
  ...
  updateOptionButtons() {
    ...
    this.setOptionButtonState(this.refs.renameDirectoryOptionButton, this.model.getFindOptions().renameDirectory);
  }
  ...
  toggleRenameDirectoryOption() {
    this.search({onlyRunIfActive: true, renameDirectory: !this.model.getFindOptions().renameDirectory});
  }
};
